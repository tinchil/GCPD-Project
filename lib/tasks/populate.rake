...
namespace :db do
  ...
  task :populate => :environment do
    ...
    # Major Crimes (from DC Comics)
    msawyer  = FactoryBot.create(:officer, username: "msawyer", role: "chief", first_name: "Maggie", last_name: "Sawyer", rank: "Captain", unit: major_crimes)
    sessen  = FactoryBot.create(:officer, username: "sessen", role: "chief", first_name: "Sarah", last_name: "Essen", rank: "Captain", unit: major_crimes, active: false)
    dcornwell  = FactoryBot.create(:officer, username: "dcornwell", role: "officer", first_name: "David", last_name: "Cornwell", rank: "Lieutenant", unit: major_crimes)
    jblake   = FactoryBot.create(:officer, username: "jblake", role: "officer", unit: major_crimes)
    jazeveda = FactoryBot.create(:officer, username: "jazeveda", role: "officer", first_name: "Josh", last_name: "Azeveda", rank: "Detective", unit: major_crimes)
    jbartlett = FactoryBot.create(:officer, username: "jbartlett", role: "officer", first_name: "Jane", last_name: "Bartlett", rank: "Detective", unit: major_crimes)
    hbullock = FactoryBot.create(:officer, username: "hbullock", role: "officer", first_name: "Harvey", last_name: "Bullock", rank: "Detective", unit: major_crimes)
    tburke = FactoryBot.create(:officer, username: "tburke", role: "officer", first_name: "Thomas", last_name: "Burke", rank: "Detective", unit: major_crimes)
    rchandler = FactoryBot.create(:officer, username: "rchandler", role: "officer", first_name: "Romy", last_name: "Chandler", rank: "Detective", unit: major_crimes)
    ecohen = FactoryBot.create(:officer, username: "ecohen", role: "officer", first_name: "Eric", last_name: "Cohen", rank: "Detective", unit: major_crimes)
    jdavies = FactoryBot.create(:officer, username: "jdavies", role: "officer", first_name: "Jackson", last_name: "Davies", rank: "Detective Sergeant", unit: major_crimes)
    ncrowe = FactoryBot.create(:officer, username: "ncrowe", role: "officer", first_name: "Nelson", last_name: "Crowe", rank: "Detective", unit: major_crimes)
    varrazzio = FactoryBot.create(:officer, username: "varrazzio", role: "officer", first_name: "Vincent", last_name: "Arrazzio", rank: "Detective Sergeant", unit: major_crimes)
    ...
    # Homicide (from DC Comics)
    calvarez  = FactoryBot.create(:officer, username: "calvarez", role: "officer", first_name: "Carlos", last_name: "Alvarez", rank: "Detective", unit: homicide)
    jbard  = FactoryBot.create(:officer, username: "jbard", role: "officer", first_name: "Jason", last_name: "Bard", rank: "Detective", unit: homicide)
    bbilbao  = FactoryBot.create(:officer, username: "bbilbao", role: "officer", first_name: "Brian", last_name: "Bilbao", rank: "Lieutenant", unit: homicide)
    ghennelly  = FactoryBot.create(:officer, username: "ghennelly", role: "chief", first_name: "Gerrard", last_name: "Hennelly", rank: "Captain", unit: homicide)
    dpeak  = FactoryBot.create(:officer, username: "dpeak", role: "officer", first_name: "Donald", last_name: "Peak", rank: "Officer", unit: homicide)
    rmulcahey  = FactoryBot.create(:officer, username: "rmulcahey", role: "officer", first_name: "Rebecca", last_name: "Mulcahey", rank: "Officer", unit: homicide)
    homicide_officers = [calvarez,jbard,bbilbao,dpeak,rmulcahey]
    puts "Created Homicide officers"

    # Patrol
    cmason  = FactoryBot.create(:officer, username: "cmason", role: "chief", first_name: "Catherine", last_name: "Mason", rank: "Captain", unit: patrol)
    50.times do
      create_officer_for(patrol)
    end
    puts "Created Patrol officers"

    # Narcotics
    ddelaware  = FactoryBot.create(:officer, username: "ddelaware", role: "chief", first_name: "Derek", last_name: "Mason", rank: "Captain", unit: narcotics)
    12.times do
      create_officer_for(narcotics)
    end
    puts "Created Narcotics officers"

    # Quick Response Team
    jcolby  = FactoryBot.create(:officer, username: "jcolby", role: "chief", first_name: "James", last_name: "Colby", rank: "Captain", unit: quick_response)
    24.times do
      create_officer_for(quick_response)
    end
    ...
    20.times do
      ...
      temp = homicide_officers - [investigator]
      second_investigator = temp.sample
      ...
      second_officer_assignment = FactoryBot.create(:assignment, investigation: murder1_investigation, officer: second_investigator) if rand(26) % 6 == 0
    ...
    25.times do
      ...
      second_officer_assignment = FactoryBot.create(:assignment, investigation: this_investigation, officer: second_investigator) if rand(26) % 4 == 0
    end
...
def create_officer_for(unit)
  first_name = Faker::Name.first_name
  last_name = Faker::Name.last_name
  username = "#{first_name[0].downcase}#{last_name.downcase}#{rand(999)}"
  this_officer  = FactoryBot.create(:officer, username: username, role: "officer", first_name: first_name, last_name: last_name, rank: "Officer", unit: unit)
end